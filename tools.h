...
class YellowNameCheckBox : public QCheckBox
{
	Q_OBJECT
public:
	YellowNameCheckBox(int id, MainWindow *mainWindow, QWidget *parent = nullptr);
signals:
	void dataChanged(bool value);
public slots:
	void updateSave(int i);
...
private:
	int id;
	int values[3] = {0, 1, 2};
	QMap<int, Qt::CheckState> states = { {0, Qt::Unchecked}, {1, Qt::Checked}, {2, Qt::Checked} };
	MainWindow *mw;
};
