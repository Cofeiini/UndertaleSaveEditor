export class CommonEditor {
    ...
    constructor(args) {
        ...
        this.editorLayout.append(this.editor);
    ...
    constructor(args) {
        ...
        switch (args.id) {
            ...
            case 188: {
                ...
                this.addItem("Spared");
                this.indexes[2] = 2;
                this.addItem("Body destroyed");
                this.indexes[3] = 3;
                break;
            }
            case 189: {
                this.addItem("Pink Dress");
                this.indexes[0] = 0;
                this.addItem("White Dress");
                this.indexes[1] = 1;
                this.addItem("Teal Dress");
                this.indexes[2] = 2;
            ...
            case 284: {
                ...
                this.indexes[2] = 2;
                this.addItem("(A useless pile of snow.)");
                this.indexes[3] = 3;
                break;
            }
            case 298: {
            ...
            case 427: {
                ...
                this.indexes[5] = 5;
                this.addItem(`Finished battle with ${Str_Muffet}`);
                this.indexes[6] = 6;
                break;
            }
            case 429: {
