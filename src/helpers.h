...
// NOLINTNEXTLINE: Done on purpose to make the macros easier to access
namespace {
// ##### Credits #####
// clang-format off
#define Project_Credits QStringList { "chaoskagami", "Araraura", "hax4dazy", "EpicSpieler", "donlon" }
// clang-format on
...
constexpr bool bitCheck(const auto var, const quint64 bit)
{
    return (var & bit) > 0;
}
