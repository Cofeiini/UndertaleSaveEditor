...
public:
	explicit CustomRadioButton(int id, QString text, QWidget *buddyWidget = nullptr);
...
private:
	const QVector<int> atValues = { 0, 3, 5, 7, 2, 10, 12, 15, 99 };
	const QHash<int, int> indexes = { { 3, 0 }, { 13, 1 }, { 14, 2 }, { 25, 3 }, { 45, 4 }, { 47, 5 }, { 49, 6 }, { 51, 7 }, { 52, 8 } };
};
...
private:
	const QVector<int> dfValues = { 0, 3, 7, 10, 5, 11, 12, 15, 99, 20 };
	const QHash<int, int> indexes = { { 4, 0 }, { 12, 1 }, { 15, 2 }, { 24, 3 }, { 44, 4 }, { 46, 5 }, { 48, 6 }, { 50, 7 }, { 53, 8 }, { 64, 9 } };
};
...
class YellowCheckBox : public CustomCheckBox
{
	Q_OBJECT

public:
	explicit YellowCheckBox(int id, const QString text = "", QWidget *buddyWidget = nullptr);
...
private:
	QVector<int> values = { 0, 1, 2 };
	QHash<int, Qt::CheckState> states = { { 0, Qt::Unchecked }, { 1, Qt::PartiallyChecked }, { 1, Qt::Checked } };
};
