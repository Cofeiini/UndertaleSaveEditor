...
QRegularExpression lastCommaRegex("(.+),(.+)$"); // NOLINT: Have a single instance instead of several in each widget
    ...
    editor(editorWidget), id(identifier), buddy(buddyWidget)
{
    ...
    connect(MainWindow::instance, &MainWindow::toggleDarkMode, this, [this](const bool isDarkMode) -> void {
        ...
        setStyleSheet(QStringLiteral("CustomEditor > QLabel { color: %1; } CustomEditor:hover { padding: 4px; border: 1px solid %2; }").arg(fontColor, hoverColor));
    });
...
CustomEditor::~CustomEditor()
{
    ...
    {
        return; // Early return to prevent accessing deleted widgets on shutdown
    }
...
bool CustomEditor::eventFilter(QObject *watched, QEvent *event)
{
...
void CustomEditor::mouseReleaseEvent(QMouseEvent *event)
{
...
CustomLineEdit::CustomLineEdit(const int editorId, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QLineEdit(), buddyWidget)
{
...
// NOLINTNEXTLINE: Necessary exception to make the system work
CustomComboBox::CustomComboBox(int editorId, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QComboBox(), buddyWidget)
{
    ...
    switch (editorId)
    {
        ...
        case 45:
        {
            ...
            addHintText(QStringLiteral(R"(If set to "%1" in %2, %3 will mention it)").arg(editor->itemText(3), Str_Ruins, Str_Mad_Dummy));
            break;
        }
        case 53:
        {
            ...
            addHintText(QStringLiteral(R"(If not "%1", there will be a pile of yellow names in the Trash Zone)").arg(editor->itemText(0)));
            break;
        }
        case 65:
        {
            ...
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"("You took a piece of candy.")"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"("You took more candy.")"));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("You take another piece.")"));
            indexes.insert(3, 3);
            editor->addItem(QStringLiteral(R"("You took too much too fast.")"));
            indexes.insert(4, 4);
            break;
        }
        case 67:
        ...
        case 68:
        {
            ...
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"("My apologies. A strange dog kidnapped my phone.")"));
            indexes.insert(2, 2);
            break;
        }
        case 76:
        {
            editor->addItem(QStringLiteral(R"(Arrived at "Home")"));
            indexes.insert(0, 0);
        ...
        case 88:
        {
            ...
            addHintText(QStringLiteral(R"(If "%1", Chilldrakes will begin to show up)").arg(editor->itemText(2)));
            break;
        }
        case 89:
        {
        ...
        case 98:
        {
            ...
            addHintText(QStringLiteral(R"(If "%1", skip %2' battle)").arg(editor->itemText(0), Str_Papyrus));
            break;
        }
        case 103:
        {
        ...
        case 112:
        {
            ...
            addHintText(QStringLiteral(R"(If "%1", you'll know the song for %2 and %3)").arg(editor->itemText(2), Str_Knight_Knight, Str_Lemon_Bread));
            break;
        }
        case 119:
        {
        ...
        case 121:
        {
            ...
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"("You can't hold an umbrella either?")"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"("You got us an umbrella?")"));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("Where's the umbrella...?")"));
            indexes.insert(3, 3);
            break;
        }
        case 122:
        ...
        case 127:
        {
            editor->addItem(QStringLiteral(R"("That emblem")"));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"_("Emblem's meaning (NEW)")_"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"_("The prophecy (NEW)")_"));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("The prophecy")"));
            indexes.insert(3, 3);
            break;
        }
        case 129:
        ...
        case 138:
        {
            editor->addItem(QStringLiteral(R"("It's a legendary artifact.")"));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"("The artifact is gone.")"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"("You're carrying too many dogs.")"));
            indexes.insert(2, 2);
            break;
        }
        case 139:
        ...
        case 284:
        {
            editor->addItem(QStringLiteral(R"("Hello. I am a snowman. I cannot move.")"));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"("Soon there won't be any of me left...")"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"("Stop... Please...")"));
            indexes.insert(2, 2);
        ...
        case 427:
        {
            editor->addItem(QStringLiteral(R"("Did you hear what they said?")"));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"("They said a human wearing a striped shirt...")"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"("I heard that they hate spiders.")"));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("I heard that they love to stomp on them.")"));
            indexes.insert(3, 3);
            editor->addItem(QStringLiteral(R"("I heard that they like to tear their legs off.")"));
            indexes.insert(4, 4);
            editor->addItem(QStringLiteral(R"("I heard...")"));
            indexes.insert(5, 5);
        ...
        case 436:
        {
            editor->addItem(QStringLiteral(R"("About your wares")"));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"_("Origin of wares (NEW)")_"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"_("Origin of garbage (NEW)")_"));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("Origin of garbage")"));
            indexes.insert(3, 3);
            break;
        }
        case 437:
        {
            editor->addItem(QStringLiteral(R"("About %1")").arg(Str_Mettaton));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"_("Origin of %1 (NEW)")_").arg(Str_Mettaton));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"_("About %1 (OLD???)")_").arg(Str_Mettaton));
            indexes.insert(2, 2);
            break;
        }
        case 438:
        {
            editor->addItem(QStringLiteral(R"("About %1")").arg(Str_Alphys));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"_("Royal Scientist (NEW)")_"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"_("About %1 (NEW)")_").arg(Str_Asgore.toUpper()));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("About %1")").arg(Str_Asgore.toUpper()));
            indexes.insert(3, 3);
            break;
        }
        case 444:
        ...
        case 467:
        {
            editor->addItem(QStringLiteral(R"("%1")").arg(Str_Mettaton));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"_("Why is %1 bad (NEW)")_").arg(Str_Mettaton));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"_("Why else is MTT bad (NEW)")_"));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("Why else is MTT bad")"));
            indexes.insert(3, 3);
            break;
        }
        case 468:
        {
            editor->addItem(QStringLiteral(R"([B.Pants] "Romance Advice")"));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"_([B.Pants] "Glamburger Story (NEW)")_"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"_([B&C] "%1 (NEW)")_").arg(Str_Burger_Pants));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"_([B&C] "More %1 (NEW)")_").arg(Str_Burger_Pants));
            indexes.insert(4, 3);
            editor->addItem(QStringLiteral(R"_([B.Pants] "%1 (NEW)")_").arg(Str_Bratty_and_Catty));
            indexes.insert(5, 4);
            editor->addItem(QStringLiteral(R"_([B&C] "%1 hangout (NEW)")_").arg(Str_Burger_Pants));
            indexes.insert(6, 5);
            editor->addItem(QStringLiteral(R"_([B&C] "That kind of guy (NEW)")_"));
            indexes.insert(7, 6);
            editor->addItem(QStringLiteral(R"_([B.Pants] "%1's Invitation (NEW)")_").arg(Str_Catty));
            indexes.insert(8, 7);
            editor->addItem(QStringLiteral(R"([B.Pants] "%1's Invitation")").arg(Str_Catty));
            indexes.insert(9, 8);
        ...
        case 481:
        {
            editor->addItem(QStringLiteral(R"("A long time ago, a human fell into %1.")").arg(Str_Ruins.toUpper()));
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"("%1, the king's son, heard the human's call.")").arg(Str_Asriel.toUpper()));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"("Over time, %1 and the human became like siblings.")").arg(Str_Asriel.toUpper()));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("Then... One day...")"));
            indexes.insert(3, 3);
            editor->addItem(QStringLiteral(R"("The sick human had only one request.")"));
            indexes.insert(4, 4);
            editor->addItem(QStringLiteral(R"("The next day.")"));
            indexes.insert(5, 5);
            editor->addItem(QStringLiteral(R"("%1, wracked with grief, absorbed the human's SOUL.")").arg(Str_Asriel.toUpper()));
            indexes.insert(6, 6);
            editor->addItem(QStringLiteral(R"("With the human SOUL, %1 crossed through the barrier.")").arg(Str_Asriel.toUpper()));
            indexes.insert(7, 7);
            editor->addItem(QStringLiteral(R"("%1 reached the center of the village.")").arg(Str_Asriel.toUpper()));
            indexes.insert(8, 8);
            editor->addItem(QStringLiteral(R"("Suddenly, screams rang out.")"));
            indexes.insert(9, 9);
            editor->addItem(QStringLiteral(R"("The humans attacked him with everything they had.")"));
            indexes.insert(10, 10);
            editor->addItem(QStringLiteral(R"("But...")"));
            indexes.insert(11, 11);
            editor->addItem(QStringLiteral(R"("Wounded, %1 stumbled home.")").arg(Str_Asriel.toUpper()));
            indexes.insert(12, 12);
            editor->addItem(QStringLiteral(R"("The kingdom fell into despair.")"));
            indexes.insert(13, 13);
            editor->addItem(QStringLiteral(R"("The king decided it was time to end our suffering.")"));
            indexes.insert(14, 14);
            editor->addItem(QStringLiteral(R"("It's not long now.")"));
            indexes.insert(15, 15);
            editor->addItem(QStringLiteral(R"("You should be smiling, too.")"));
            indexes.insert(16, 16);
            editor->addItem(QStringLiteral(R"("You're going to be free.")"));
        ...
        case 527:
        {
            ...
            editor->addItem(QStringLiteral("No interaction"));
            indexes.insert(0, 1);
            editor->addItem(QStringLiteral(R"("I'm %1!")").arg(Str_Onionsan));
            indexes.insert(1, 2);
            editor->addItem(QStringLiteral(R"("You're visiting %1, huh!")").arg(Str_Waterfall));
            indexes.insert(2, 3);
            editor->addItem(QStringLiteral(R"("Even though, the water's getting so shallow here...")"));
            indexes.insert(3, 4);
            editor->addItem(QStringLiteral(R"("%1's gonna fix everything, y'hear!")").arg(Str_Undyne));
            indexes.insert(4, 5);
            editor->addItem(QStringLiteral(R"("That's the end of this room.")"));
            indexes.insert(5, 6);
            editor->addItem(QStringLiteral(R"("Yeah, me too...")"));
            indexes.insert(6, 7);
            editor->addItem(QStringLiteral(R"("I've been wondering when we're all gonna go free.")"));
            indexes.insert(7, 8);
            break;
        }
        case 528:
        ...
        case 540:
        {
            ...
            indexes.insert(0, 0);
            editor->addItem(QStringLiteral(R"("00.001")"));
            indexes.insert(1, 1);
            editor->addItem(QStringLiteral(R"("00.0001")"));
            indexes.insert(2, 2);
            editor->addItem(QStringLiteral(R"("00.000001")"));
            indexes.insert(3, 3);
            editor->addItem(QStringLiteral(R"("00.0000000001")"));
            indexes.insert(4, 4);
            break;
        }
        case 541:
...
// NOLINTNEXTLINE: Necessary exception to make the system work
CustomSpinBox::CustomSpinBox(int editorId, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QDoubleSpinBox(), buddyWidget)
{
    ...
    switch (editorId)
    {
        ...
        case 36:
        {
            ...
            callback = [this, hintTitle]() -> void {
                ...
                if ((value >= 2) && (value <= 39))
                {
                    hintText = QStringLiteral("Wrong Number Song");
                }
                else if ((value >= 40) && (value <= 45))
                {
                    hintText = QStringLiteral("sans's call");
                }
                else if ((value >= 46) && (value <= 50))
                {
                    hintText = QStringLiteral("Alphys's call");
                }
                else if ((value >= 56) && (value <= 57))
                {
                    hintText = QStringLiteral("Nightmare Mode");
                }
                else if (value == 61)
                {
                    hintText = QStringLiteral("Gaster Follower #2");
                }
                else if (value == 62)
                {
                    hintText = QStringLiteral("Gaster Follower #1");
                }
                else if (value == 63)
                {
                    hintText = QStringLiteral("Gaster Follower #3");
                }
                else if (value == 65)
                {
                    hintText = QStringLiteral("Sound Test Room");
                }
                else if (value == 66)
                {
                    hintText = QStringLiteral("Fake Hallway");
                }
                else if ((value >= 80) && (value <= 89))
                {
                    hintText = QStringLiteral("Clam Girl");
                }
                else if ((value >= 91) && (value <= 100))
                {
                    hintText = QStringLiteral("Goner Kid");
                }
        ...
        case 56:
        {
            addHintText(QStringLiteral(R"(If this is >5, remove a frog from the "four frog" room)"));
            break;
        }
        case 57:
        {
            editor->setRange(0, 50);
            addHintText(QStringLiteral(R"(Overrides your "progress" through the genocide route when this is >0)"));
            break;
        }
        case 71:
        {
        ...
        case 384:
        {
            addHintText(QStringLiteral(R"(Affects dialog with "Clamguy"<br />If True Pacifist and the puddle is large, a small tree will begin to grow)"));
            break;
        }
        case 388:
        {
...
// NOLINTNEXTLINE: Necessary exception to make the system work
CustomCheckBox::CustomCheckBox(int editorId, const QString &text, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QCheckBox(), buddyWidget)
{
    editor->setText(text);
    ...
    switch (editorId)
    {
        ...
        case 122:
        {
            addHintText(QStringLiteral(R"(This value is also used for "Interaction with %1")").arg(Str_Monster_Kid));
            break;
        }
        case 126:
        {
        ...
        case 308:
        {
            addHintText(QStringLiteral(R"(This applies only if "fun value" is correct)"));
            break;
        }
        case 309:
        {
        ...
        case 327:
        {
            addHintText(QStringLiteral(R"(Begins the "quest")"));
            break;
        }
        case 383:
        {
        ...
        case 496:
        {
            addHintText(QStringLiteral(R"(Changes "%1's Phone" to "%1 and %2")").arg(Str_Papyrus, Str_Undyne));
            break;
        }
        case 510:
        {
...
// NOLINTNEXTLINE: Necessary exception to make the system work
CustomRadioButton::CustomRadioButton(int editorId, const QString &text, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QRadioButton(), buddyWidget)
{
    editor->setText(text);
...
// NOLINTNEXTLINE: Necessary exception to make the system work
ItemComboBox::ItemComboBox(int editorId, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QComboBox(), buddyWidget)
{
    editor->setEditable(true);
    editor->lineEdit()->setFrame(false);
...
void ItemComboBox::mouseReleaseEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton)
    {
        editor->showPopup();
...
// NOLINTNEXTLINE: Necessary exception to make the system work
PhoneComboBox::PhoneComboBox(int editorId, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QComboBox(), buddyWidget)
{
    editor->setEditable(true);
    editor->lineEdit()->setFrame(false);
    ...
    editor->addItem(QStringLiteral(R"(Call Her "Mom")"));
...
void PhoneComboBox::mouseReleaseEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton)
    {
        editor->showPopup();
...
// NOLINTNEXTLINE: Necessary exception to make the system work
WeaponComboBox::WeaponComboBox(int editorId, QWidget *buddyWidget, CustomSpinBox *weaponAT) :
    CustomEditor(editorId, editor = new QComboBox(), buddyWidget), wat(weaponAT)
{
    editor->setEditable(true);
    editor->lineEdit()->setFrame(false);
    editor->lineEdit()->setReadOnly(true);
...
void WeaponComboBox::mouseReleaseEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton)
    {
        editor->showPopup();
...
// NOLINTNEXTLINE: Necessary exception to make the system work
ArmorComboBox::ArmorComboBox(int editorId, QWidget *buddyWidget, CustomSpinBox *armorDF) :
    CustomEditor(editorId, editor = new QComboBox(), buddyWidget), adf(armorDF)
{
    editor->setEditable(true);
    editor->lineEdit()->setFrame(false);
    editor->lineEdit()->setReadOnly(true);
...
void ArmorComboBox::mouseReleaseEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton)
    {
        editor->showPopup();
...
// NOLINTNEXTLINE: Necessary exception to make the system work
RoomComboBox::RoomComboBox(int editorId, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QComboBox(), buddyWidget)
{
    editor->setEditable(true);
    editor->lineEdit()->setFrame(false);
    ...
    addHintText(QStringLiteral(R"(Determines the room where you will spawn.<br />Some rooms are unavailable and will trigger "Dogcheck" without a modified game)"));

    connect(editor, &QComboBox::currentIndexChanged, this, &RoomComboBox::updateSave);
}

void RoomComboBox::mouseReleaseEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton)
    {
        editor->showPopup();
...
// NOLINTNEXTLINE: Necessary exception to make the system work
TimeEdit::TimeEdit(int editorId, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QDoubleSpinBox(), buddyWidget)
{
    editor->setRange(0, std::numeric_limits<double>::max());
    editor->setDecimals(0);
...
// NOLINTNEXTLINE: Necessary exception to make the system work
PlotEdit::PlotEdit(int editorId, QWidget *buddyWidget) :
    CustomEditor(editorId, editor = new QComboBox(), buddyWidget)
{
    editor->setEditable(true);
    editor->lineEdit()->setFrame(false);
    ...
    editor->addItem(QStringLiteral(R"(You asked "How to exit the %1")").arg(Str_Ruins));
    ...
    editor->addItem(QStringLiteral(R"("Solved" %1's puzzle)").arg(Str_sans));
    ...
    editor->addItem(QStringLiteral(R"("Solved" the Multicolor Tile Puzzle)"));
    ...
    editor->addItem(QStringLiteral("%1 left the area").arg(Str_Greater_Dog));
    editor->addItem(QStringLiteral(R"("Solved" the final puzzle)"));
...
void PlotEdit::mouseReleaseEvent(QMouseEvent *event)
{
    if (event->button() == Qt::LeftButton)
    {
        editor->showPopup();
