...
BossesPage::BossesPage(QWidget *parent) :
    QTabWidget(parent)
{
    tabBar()->setDocumentMode(true);
    tabBar()->setExpanding(true);
    ...
    torielLayout->addWidget(new CustomSpinBox(71, new QLabel(QStringLiteral(R"(Said "Hello")"))));
    torielLayout->addWidget(new CustomCheckBox(72, QStringLiteral("Flirted with %1").arg(Str_Toriel)));
    torielLayout->addWidget(new CustomCheckBox(73, QStringLiteral(R"(Called %1 "Mom")").arg(Str_Toriel)));
...
MonstersPage::MonstersPage(QWidget *parent) :
    QTabWidget(parent)
{
    tabBar()->setDocumentMode(true);
    tabBar()->setExpanding(true);
    ...
    temmieLayout->addWidget(new CustomCheckBox(307, QStringLiteral(R"(Sent %1 to "cool leg")").arg(Str_Temmie)));
...
LocationsPage::LocationsPage(QWidget *parent) :
    QTabWidget(parent)
{
    tabBar()->setDocumentMode(true);
    tabBar()->setExpanding(true);
    ...
    ruinsLayout->addWidget(new CustomCheckBox(81, QStringLiteral(R"(Learned about "water sausages")")));
    ...
    snowdinLayout->addWidget(new CustomComboBox(89, new QLabel(QStringLiteral(R"("Harder" puzzle)"))));
    ...
    snowdinLayout->addWidget(new CustomCheckBox(308, QStringLiteral(R"(The "Wrong Number" event)")));
    ...
    snowdinLayout->addWidget(new CustomCheckBox(114, QStringLiteral(R"(Found 20G inside the "saggy old couch")")));
    snowdinLayout->addWidget(new CustomCheckBox(314, QStringLiteral("Checked %1's kitchen after the date").arg(Str_Papyrus)));
    snowdinLayout->addWidget(new CustomCheckBox(292, QStringLiteral(R"(Tried to pet the dog in the "dev room")")));
...
ShrinePage::ShrinePage(QWidget *parent) :
    QScrollArea(parent)
{
    setWidgetResizable(true);
...
IniPage::IniPage(QWidget *parent) :
    QScrollArea(parent)
{
    setWidgetResizable(true);
